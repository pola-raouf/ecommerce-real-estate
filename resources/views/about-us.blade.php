...
<body>
    ...
    <div class="container my-5 pt-5">
        ...
        <div class="text-center mb-5 fade-up">
            ...
            <p class="lead text-secondary-light">Learn more about EL Kayan and our mission in the real estate market.
            </p>
        </div>
        ...
        <div class="row align-items-center mb-5 fade-up">
            <div class="col-md-6 mb-4 mb-md-0">
                <img src="{{ url('images/main1.jpg') }}" class="img-fluid rounded shadow-lg about-image glow-hover"
                    alt="EL Kayan">
            </div>
            <div class="col-md-6 text-light">
                <h2 class="fw-bold mb-3">Who We Are</h2>
                <p>EL Kayan is a modern real estate platform dedicated to connecting buyers, sellers, and renters with
                    their ideal properties...</p>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-12 text-center mb-4 fade-up">
                <h2 class="fw-bold text-light">Why Choose EL Kayan?</h2>
                <p class="lead text-secondary-light">We're committed to excellence in every aspect of real estate</p>
            </div>
            <div class="col-md-4 mb-4 fade-up">
                <div class="p-4 bg-dark rounded shadow-sm hover-card glow-hover text-center">
                    <div class="mb-3">
                        <i class="bi bi-shield-check-fill text-primary" style="font-size: 3rem;"></i>
                    </div>
                    <h4 class="fw-bold mb-3 text-primary">Trusted Service</h4>
                    <p class="text-light">Verified listings with professional support throughout your property journey.
                    </p>
                </div>
            </div>
            <div class="col-md-4 mb-4 fade-up">
                <div class="p-4 bg-dark rounded shadow-sm hover-card glow-hover text-center">
                    ...
                    <h4 class="fw-bold mb-3 text-primary">Premium Properties</h4>
                    <p class="text-light">Handpicked selection of luxury homes in the most desirable neighborhoods.</p>
                </div>
            </div>
            <div class="col-md-4 mb-4 fade-up">
                <div class="p-4 bg-dark rounded shadow-sm hover-card glow-hover text-center">
                    ...
                    <h4 class="fw-bold mb-3 text-primary">Expert Team</h4>
                    <p class="text-light">Experienced professionals dedicated to finding your perfect property.</p>
                </div>
            </div>
        </div>
